...
- Applications will have to be rebound to receive the hostname or IP that resolves to the load balancer. To rebind: unbind your application from the service instance, bind it again, then restage your application. For more information see [Managing Service Instances with the CLI](/pivotalcf/1.6/devguide/services/managing-services.html). In order to avoid unnecessary rebinding, we recommend configuring a load balancer before deploying v1.5.0.
...
For more information about the use of services, see the [Services Overview](/pivotalcf/1.6/devguide/services/).
...
## <a id="SeeAlso"></a>See Also##
  ...
  * [Backing Up MySQL for PCF](backup.html)<br>
    **Note**: For information about backing up your PCF installation, refer to [Backing Up and Restoring Pivotal Cloud Foundry&reg;](/pivotalcf/1.6/customizing/backup-restore/index.html).
